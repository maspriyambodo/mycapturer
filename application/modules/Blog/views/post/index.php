<div class="card card-custom">
    <div class="card-body">
        ...
        if ($privilege['create']) { // jika memiliki privilege tambah data / create
            ...
            . '<a href="' . site_url('Blog/Post/Add/') . '" class="btn btn-primary mr-2"><i class="far fa-plus-square"></i> Add new</a>'
            . '</div>'
            . '</div>';
        } else {
            null;
...
<script>
    window.onload = function () {
        ...
        $('table').dataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('Blog/Post/lists') ?>",
                "type": "POST"
            },
            columnDefs: [
                {
    ...
    function Edit(id) {
        window.location.href = 'Blog/Post/Edit?id_post=' + id;
    }
</script>