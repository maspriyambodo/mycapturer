...
<div class="card card-custom">
    <form id="post_form" action="<?php echo base_url('Compro/Pages/update_page?service=' . Post_get('service')); ?>" method="POST">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select id="post_title" name="post_title" class="form-control custom-select" required="">
                            <?php
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" id="post_tags" name="post_tags" class="form-control" required="" autocomplete="off" value="<?php echo $data['post_tags']; ?>"/>
            ...
            <div class="form-group">
                ...
                <textarea id="editor1" name="post_content"><?php echo $data['post_content']; ?></textarea>
            </div>
        </div>
