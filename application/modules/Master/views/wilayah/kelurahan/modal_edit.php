<div class="modal fade" id="modal_edit" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="modal_edit" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form_edit" action="<?php echo base_url('Master/Wilayah/Kelurahan/Update/'); ?>" method="post">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="e_kectxt">Kecamatan:</label>
                                <br>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="e_idkel">ID Kelurahan:</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="e_keltxt">Nama Kelurahan:</label>
...
<script>
    ...
    function Edit(val) {
        $.ajax({
            url: "<?php echo base_url('Master/Wilayah/Kelurahan/Detail?id='); ?>" + val,
            type: 'GET',
            cache: false,
            contentType: false,
            processData: false,
            success: function (data) {
                if (data.stat == true) {
                    ...
                    opt.value = data.results.id_kecamatan;
                    opt.text = data.results.kecamatan;
                    sel.add(opt, sel.options);
                    $('input[name="e_idkel"]').val(data.results.id_kelurahan);
