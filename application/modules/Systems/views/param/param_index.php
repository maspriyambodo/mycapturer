                ...
                <tbody>
                    ...
                    foreach ($data as $value) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $value->param_group; ?></td>
                            <td class="text-center"><?php echo $value->param_value; ?></td>
                            <td><?php echo $value->param_desc; ?></td>
                            <td class="text-center">
                                <?php
                                $editbtn = '<button id="editbtn" type="button" class="btn btn-icon btn-warning btn-xs" title="Edit Group Menu" value="' . $id . '" onclick="Edit(this.value)"><i class="far fa-edit"></i></button>';
                                $delbtn = '<button id="delbtn" type="button" class="btn btn-icon btn-danger btn-xs" title="Delete Group Menu" value="' . $id . '" onclick="Delete(this.value)"><i class="far fa-trash-alt"></i></button>';
                                echo '<div class="btn-group">'; // open div btn-group
                                if ($privilege['update']) { // jika memiliki privilege edit
                                    echo $editbtn;
                                }
                                if ($privilege['delete']) { // jika memiliki privilege delete
                                    echo $delbtn;
                                }
